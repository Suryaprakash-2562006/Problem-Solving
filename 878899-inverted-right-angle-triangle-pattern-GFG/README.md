# [Inverted Right Angle Triangle Pattern](https://www.geeksforgeeks.org/problems/inverted-right-angletriangle-1605691171--104349/1?page=1&category=Java&status=unsolved&sortBy=submissions)
## Easy
