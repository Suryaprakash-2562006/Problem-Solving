# [ArrayList Operations](https://www.geeksforgeeks.org/problems/arraylist-operations/1?page=1&category=Java&difficulty=Basic,Easy&status=unsolved&sortBy=submissions)
## Easy
